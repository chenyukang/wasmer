...
static void init_func_types(void) {
  func_types[0] = wasm_rt_register_func_type(1, 1, WASM_RT_F64, WASM_RT_I32);
}

static u32 w2c_f0(f64);
static u32 w2c_f1(f64);

static void init_globals(void) {
}

static u32 w2c_f0(f64 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  UNREACHABLE;
  FUNC_EPILOGUE;
